    ...
    <?php if(auth()->guard()->guest()): ?>
        <div class="mx-auto max-w-md rounded-xl border border-line bg-surface p-8 text-center">
            ...
            <p class="mt-4 text-sm text-ink-muted">
                Belum punya akun? <a href="<?php echo e(route('register')); ?>" class="text-accent hover:underline">Daftar di sini</a>
            </p>
        </div>
    <?php else: ?>
        ...
        <div class="mt-8 grid gap-8 lg:grid-cols-[280px_1fr]">
            <aside class="space-y-4">
                <div class="rounded-xl border border-line bg-surface p-5">
                    ...
                    <p class="mt-1 text-sm text-accent"><?php echo e($selectedService !== '' ? $selectedService : 'Pilih layanan yang Anda inginkan'); ?></p>
                    <a href="<?php echo e(route('services.index')); ?>" class="mt-2 inline-block text-xs text-ink-muted hover:text-accent">
                ...
                <div class="rounded-xl border border-line bg-surface p-5">
                    ...
                    <p class="mt-1 text-sm text-ink-muted"><?php echo e(config('site.address')); ?></p>
                    <a href="https://maps.google.com/?q=<?php echo e(urlencode(config('site.address'))); ?>" target="_blank" rel="noopener"
            ...
            <form method="POST" action="<?php echo e(route('booking.store')); ?>" class="space-y-5 rounded-xl border border-line bg-surface p-6">
                <?php echo csrf_field(); ?>
                <div class="grid gap-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" name="phone" value="<?php echo e(old('phone', auth()->user()->username)); ?>" placeholder="08xxxxxxxxxx" required
                               class="mt-2 w-full rounded-lg border border-line bg-white px-3 py-2 text-sm focus:border-accent focus:outline-none focus:ring-2 focus:ring-accent/20">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <select name="service" required
                        ...
                        <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($service->name); ?>" <?php if(old('service', $selectedService) === $service->name): echo 'selected'; endif; ?>>
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="date" name="date" id="bookingDate" min="<?php echo e(now()->toDateString()); ?>"
                               value="<?php echo e(old('date', now()->toDateString())); ?>" required
                               class="mt-2 w-full rounded-lg border border-line bg-white px-3 py-2 text-sm focus:border-accent focus:outline-none focus:ring-2 focus:ring-accent/20">
                    </div>
                    <div>
                        ...
                        <div id="slotGrid" class="mt-2 grid grid-cols-3 gap-2">
                            <?php $__currentLoopData = $timeSlots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <button type="button" data-slot="<?php echo e($slot); ?>"
                        ...
                        <input type="hidden" name="time" id="bookingTime" value="<?php echo e(old('time')); ?>" required>
        ...
        <script>
            (function () {
                ...
                async function loadSlots() {
                    ...
                    try {
                        const res = await fetch(`<?php echo e(route('booking.slots')); ?>?date=${dateInput.value}`);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/afegter/Fegas/SMT6/PROJEK_MPTI_FOREST/resources/views/booking/create.blade.php ENDPATH**/ ?>