    ...
    <div class="mt-10 grid gap-6 sm:grid-cols-2">
        <article class="group overflow-hidden rounded-2xl border border-line bg-surface">
            ...
            <div class="p-6">
                ...
                <a href="{{ route('services.index') }}" class="mt-3 inline-block text-sm font-medium text-accent hover:underline">Explore &rarr;</a>
            </div>
        </article>
...
<section class="bg-surface py-20">
    <div class="mx-auto max-w-6xl px-6">
        <div class="flex items-end justify-between">
            ...
            <a href="{{ route('products.index') }}" class="hidden text-sm font-medium text-accent hover:underline sm:block">See all &rarr;</a>
        </div>
