                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td class="header">
                            ...
                            <p class="invoice-title">{{ $data['title'] }}</p>
                        </td>
                    </tr>
                </table>
                            ...
                            <div class="invoice-card">
                                ...
                                <table class="info-table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="info-value">{{ $booking->service_name }}</td>
                                    </tr>
                                    <tr>
                                        <td class="info-label">Tanggal</td>
                                        <td class="info-value">{{ $booking->booking_date->format('d M Y') }}</td>
                                    </tr>
                                    @if(isset($booking->booking_time))
                                    <tr>
                                        <td class="info-label">Waktu Jeda</td>
                                        <td class="info-value">{{ $booking->booking_time->format('H:i') }} WIB</td>
                                    </tr>
                                    @endif
                                    <tr>
