                        ...
                        <td class="content">
                            ...
                            <table class="meta-table">
                                ...
                                <tr>
                                    ...
                                    <td class="meta-value">{{ $order->created_at->format('d M Y H:i') }} WIB</td>
                                </tr>
                                <tr>
                                    <td>Metode Pembayaran</td>
                                    <td class="meta-value" style="text-transform: uppercase;">{{ $order->payment_method }}</td>
                                </tr>
                                <tr>
                            ...
                            <table class="invoice-table">
                                ...
                                <tbody>
                                    ...
                                    <tr class="total-row">
                                        ...
                                        <td class="text-right grand-total" style="color: #1A1A1A;">Rp {{ number_format($order->total, 0, ',', '.') }}</td>
                                    </tr>
                                </tbody>
                            </table>
